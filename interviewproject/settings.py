...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-m+jh4!-ycaq-1a*yl6sz@#2f0y_%if)!&in#u*58xjpxot$4x4'
...
SESSION_EXPIRE_AFTER_LAST_ACTIVITY_GRACE_PERIOD = 120  # 1 minute
